...
// FIREBASE & TYPING ENGINE V5.1 (EXPERT LOADED)
// =========================================
...
// --- ローマ字変換テーブル (sho/syo, ti/chi, nn/n 等を詳細定義) ---
const KANA_MAP = {
    'あ':'a','い':'i','う':'u','え':'e','お':'o',
...
// --- データバンク (らも。Ωα様 指定リスト + 拡張100問以上) ---
const WORD_DB = {
    easy: [
        "りんご","ごりら","らっぱ","ももたろう","あいふぉん","あおもり","らんどせる",
        "みかん","すいか","いちご","ぶどう","めろん","とまと","なすび","きゅうり",
        "つくえ","いす","ほん","ぺん","のーと","かばん","くつ","ぼうし","ふく",
        "いぬ","ねこ","うさぎ","ぱんだ","らいおん","きりん","ぞう","さる","とり",
        "あお","あか","きいろ","みどり","しろ","くろ","ぴんく","ちゃいろ","むらさき",
        "はれ","あめ","くもり","ゆき","かぜ","そら","うみ","やま","かわ","いけ",
        "ごはん","ぱん","うどん","そば","かーれー","すし","てんぷら","らーめん"
    ],
    normal: [
        "こうそくどうろ","がそりんすたんど","ぽっぷこーん","ゆーちゅーぶぷれみあむ","あくしょんえいが",
        "いんたーねっと","すまーとふぉん","のーとぱそこん","でじたるかめら","てれびげーむ",
        "しょうがっこう","ちゅうがっこう","こうとうがっこう","だいがくいん","としょかん",
        "ゆうびんきょく","びょういん","けいさつしょ","しょうぼうしょ","しやくしょ",
        "しんかんせん","ちかてつ","ものれーる","ひこうき","へりこぷたー","さんさいき",
        "あにめーしょん","えんたーていめんと","ぷろぐらみんぐ","そふとうぇあ",
        "あぷりけーしょん","うぇぶさーびす","くらいあんと","さーばー","ねっとわーく"
    ],
    hard: [
        "とうごうしっちょうしょう","とっきょけんしようりょう","こくさいこうりゅうききん","こっかこうあんいいんかい",
        "こうきこうれいしゃいりょうせいど","いちふじにたかさんなすび","いしばしをたたいてわたる",
        "せいしんてきくぎょう","じょうほうしょりぎじゅつ","こくさいれんごうちあんいじ","ぎむきょういくしょとう",
        "ちてきざいさんけん","じょうほうこうかいせいど","かんきょうはかいぼうし","さいえねるぎーりよう",
        "せんもんてきちしき","しゃかいてきせきにん","こじんじょうほうほごほう","きんゆうしょうひんとりひき",
        "ぜんじんみとうのきろく","ふきしんこうふんじょうたい","がいこうかんとっけん","けんぽうかいせいぎろん"
    ]
};
