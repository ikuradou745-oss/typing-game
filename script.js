...
let currentClearCodeType = null; // 'stage', 'training'
...
// イベント問題データベース - 回答と選択肢をひらがなに修正
const EVENT_QUESTION_DB = {
    easy: [
        { question: "赤！と青！をまぜたら？", options: ["むらさき", "みどり", "きいろ"], answer: "むらさき", colors: ["赤", "青"] },
        { question: "青！と黄色！をまぜたら？", options: ["みどり", "むらさき", "おれんじ"], answer: "みどり", colors: ["青", "黄色"] },
        { question: "赤！と黄色！をまぜたら？", options: ["おれんじ", "むらさき", "みどり"], answer: "おれんじ", colors: ["赤", "黄色"] },
        { question: "白！と黒！をまぜたら？", options: ["はいいろ", "ちゃいろ", "ぴんく"], answer: "はいいろ", colors: ["白", "黒"] },
        { question: "赤！と白！をまぜたら？", options: ["ぴんく", "おれんじ", "むらさき"], answer: "ぴんく", colors: ["赤", "白"] },
        { question: "青！と白！をまぜたら？", options: ["みずいろ", "みどり", "むらさき"], answer: "みずいろ", colors: ["青", "白"] },
        { question: "黄色！と黒！をまぜたら？", options: ["きみどり", "ちゃいろ", "おれんじ"], answer: "きみどり", colors: ["黄色", "黒"] },
        { question: "赤！と黒！をまぜたら？", options: ["ちゃいろ", "むらさき", "あかくろ"], answer: "ちゃいろ", colors: ["赤", "黒"] },
        { question: "緑！と白！をまぜたら？", options: ["わかばいろ", "きみどり", "みずいろ"], answer: "わかばいろ", colors: ["緑", "白"] },
        { question: "青！と黒！をまぜたら？", options: ["しんらん", "むらさき", "こん"], answer: "こん", colors: ["青", "黒"] }
    ],
    normal: [
        { question: "紫！とオレンジ！をまぜたら？", options: ["あかむらさき", "ちゃいろ", "おうどいろ"], answer: "ちゃいろ", colors: ["紫", "オレンジ"] },
        { question: "赤！と紫！をまぜたら？", options: ["あかむらさき", "ぴんく", "わいんれっど"], answer: "あかむらさき", colors: ["赤", "紫"] },
        { question: "青！とオレンジ！をまぜたら？", options: ["ちゃいろ", "みどり", "むらさき"], answer: "ちゃいろ", colors: ["青", "オレンジ"] },
        { question: "黄色！と紫！をまぜたら？", options: ["おうどいろ", "ちゃいろ", "きみどり"], answer: "おうどいろ", colors: ["黄色", "紫"] },
        { question: "緑！とオレンジ！をまぜたら？", options: ["きみどり", "ちゃいろ", "おうどいろ"], answer: "おうどいろ", colors: ["緑", "オレンジ"] },
        { question: "白！と紫！をまぜたら？", options: ["らべんだー", "ぴんく", "みずいろ"], answer: "らべんだー", colors: ["白", "紫"] },
        { question: "黒！とオレンジ！をまぜたら？", options: ["ちゃいろ", "おうどいろ", "こげちゃ"], answer: "こげちゃ", colors: ["黒", "オレンジ"] },
        { question: "赤！とオレンジ！をまぜたら？", options: ["しゅいろ", "ぴんく", "ちゃいろ"], answer: "しゅいろ", colors: ["赤", "オレンジ"] },
        { question: "青！と紫！をまぜたら？", options: ["あいいろ", "あかむらさき", "みずいろ"], answer: "あいいろ", colors: ["青", "紫"] },
        { question: "黄色！とオレンジ！をまぜたら？", options: ["やまぶきいろ", "おうどいろ", "きんいろ"], answer: "やまぶきいろ", colors: ["黄色", "オレンジ"] },
        { question: "紫！と緑！をまぜたら？", options: ["はいいろ", "ちゃいろ", "あおみどり"], answer: "はいいろ", colors: ["紫", "緑"] },
        { question: "ピンク！と紫！をまぜたら？", options: ["あかむらさき", "まぜんた", "わいんれっど"], answer: "あかむらさき", colors: ["ピンク", "紫"] },
        { question: "水色！と黄色！をまぜたら？", options: ["きみどり", "わかくさいろ", "みんと"], answer: "きみどり", colors: ["水色", "黄色"] },
        { question: "紫！と白！をまぜたら？", options: ["らべんだー", "うすむらさき", "ぴんく"], answer: "らべんだー", colors: ["紫", "白"] }
    ],
    hard: [
        { question: "茶色！とピンク！をまぜたら？", options: ["ろーずぶらうん", "べーじゅ", "てらこった"], answer: "ろーずぶらうん", colors: ["茶色", "ピンク"] },
        { question: "水色！と黄色！をまぜたら？", options: ["わかくさいろ", "きみどり", "みんとぐりーん"], answer: "わかくさいろ", colors: ["水色", "黄色"] },
        { question: "橙！と紫！をまぜたら？", options: ["あかむらさき", "ちゃいろ", "すみれいろ"], answer: "あかむらさき", colors: ["橙", "紫"] },
        { question: "黄緑！と青！をまぜたら？", options: ["えめらるどぐりーん", "みどり", "たーこいず"], answer: "えめらるどぐりーん", colors: ["黄緑", "青"] },
        { question: "橙！とピンク！をまぜたら？", options: ["さーもんぴんく", "こーらる", "あか"], answer: "さーもんぴんく", colors: ["橙", "ピンク"] },
        { question: "紫！と黄緑！をまぜたら？", options: ["おりーぶ", "かーき", "ちゃいろ"], answer: "おりーぶ", colors: ["紫", "黄緑"] },
        { question: "茶色！と水色！をまぜたら？", options: ["ぐれーじゅ", "かーき", "もすぐりーん"], answer: "ぐれーじゅ", colors: ["茶色", "水色"] },
        { question: "だいだい色！と紫！をまぜたら？", options: ["あかむらさき", "ちゃいろ", "わいんれっど"], answer: "あかむらさき", colors: ["だいだい色", "紫"] },
        { question: "おうど色！と青！をまぜたら？", options: ["ぐれー", "みどり", "ちゃいろ"], answer: "ぐれー", colors: ["おうど色", "青"] },
        { question: "ピンク！と黄緑！をまぜたら？", options: ["きみどり", "わかくさいろ", "べーじゅ"], answer: "きみどり", colors: ["ピンク", "黄緑"] },
        { question: "みずいろ！と紫！をまぜたら？", options: ["らべんだー", "うすむらさき", "ぶるーぐれー"], answer: "らべんだー", colors: ["みずいろ", "紫"] },
        { question: "きみどり！と茶色！をまぜたら？", options: ["かーき", "おりーぶ", "もすぐりーん"], answer: "かーき", colors: ["きみどり", "茶色"] },
        { question: "赤！と茶色！をまぜたら？", options: ["あかちゃ", "てらこった", "ばーがんでぃ"], answer: "あかちゃ", colors: ["赤", "茶色"] },
        { question: "青！と紫！をまぜたら？", options: ["あいいろ", "いんでぃご", "こん"], answer: "あいいろ", colors: ["青", "紫"] },
        { question: "黄色！と緑！をまぜたら？", options: ["きみどり", "わかくさいろ", "らいむ"], answer: "きみどり", colors: ["黄色", "緑"] },
        { question: "白！と茶色！をまぜたら？", options: ["べーじゅ", "あいぼりー", "くりーむ"], answer: "べーじゅ", colors: ["白", "茶色"] },
        { question: "黒！と白！をまぜたら？", options: ["はいいろ", "しるばー", "ぐれー"], answer: "はいいろ", colors: ["黒", "白"] },
        { question: "紫！と黄色！をまぜたら？", options: ["ちゃいろ", "はいいろ", "おりーぶ"], answer: "ちゃいろ", colors: ["紫", "黄色"] },
        { question: "緑！と赤！をまぜたら？", options: ["ちゃいろ", "きいろ", "くろ"], answer: "ちゃいろ", colors: ["緑", "赤"] },
        { question: "青！と緑！をまぜたら？", options: ["あおみどり", "たーこいず", "えめらるど"], answer: "あおみどり", colors: ["青", "緑"] }
    ],
    boss: [
        { question: "赤！と青！と黄色！をまぜたら？", options: ["くろ", "しろ", "ちゃいろ"], answer: "ちゃいろ", colors: ["赤", "青", "黄色"] },
        { question: "青！と黄色！と白！をまぜたら？", options: ["みずいろ", "わかくさいろ", "みんと"], answer: "わかくさいろ", colors: ["青", "黄色", "白"] },
        { question: "赤！と白！と黒！をまぜたら？", options: ["はいいろ", "ぴんく", "ちゃいろ"], answer: "はいいろ", colors: ["赤", "白", "黒"] },
        { question: "赤！と青！と白！をまぜたら？", options: ["みずいろ", "むらさき", "ぴんく"], answer: "みずいろ", colors: ["赤", "青", "白"] },
        { question: "黄色！と青！と黒！をまぜたら？", options: ["みどり", "ちゃいろ", "ふかみどり"], answer: "ふかみどり", colors: ["黄色", "青", "黒"] },
        { question: "赤！と黄色！と黒！をまぜたら？", options: ["ちゃいろ", "おれんじ", "こげちゃ"], answer: "こげちゃ", colors: ["赤", "黄色", "黒"] },
        { question: "緑！と青！と黄色！をまぜたら？", options: ["きみどり", "えめらるど", "みんと"], answer: "きみどり", colors: ["緑", "青", "黄色"] },
        { question: "紫！と白！と黒！をまぜたら？", options: ["はいいろ", "らべんだー", "うすむらさき"], answer: "はいいろ", colors: ["紫", "白", "黒"] },
        { question: "オレンジ！と青！と黄色！をまぜたら？", options: ["ちゃいろ", "おうどいろ", "かーき"], answer: "ちゃいろ", colors: ["オレンジ", "青", "黄色"] },
        { question: "ピンク！と白！と赤！をまぜたら？", options: ["うすぴんく", "ろーず", "こーらる"], answer: "うすぴんく", colors: ["ピンク", "白", "赤"] },
        { question: "茶色！と白！と黒！をまぜたら？", options: ["べーじゅ", "はいいろ", "くりーむ"], answer: "べーじゅ", colors: ["茶色", "白", "黒"] },
        { question: "水色！と青！と白！をまぜたら？", options: ["そらいろ", "みずいろ", "うすあお"], answer: "そらいろ", colors: ["水色", "青", "白"] },
        { question: "黄緑！と緑！と黄色！をまぜたら？", options: ["きみどり", "わかくさいろ", "らいむ"], answer: "きみどり", colors: ["黄緑", "緑", "黄色"] },
        { question: "紫！と青！と赤！をまぜたら？", options: ["あんししょく", "わいんれっど", "ばーがんでぃ"], answer: "あんししょく", colors: ["紫", "青", "赤"] },
        { question: "橙！と赤！と黄色！をまぜたら？", options: ["しゅいろ", "だいだい", "きんあか"], answer: "しゅいろ", colors: ["橙", "赤", "黄色"] }
    ],
    ura1: [
        { question: "紫！と黄緑！と橙！をまぜたら？", options: ["はいいろ", "ちゃいろ", "おうどいろ"], answer: "ちゃいろ", colors: ["紫", "黄緑", "橙"] },
        { question: "ピンク！と水色！と黄色！をまぜたら？", options: ["べーじゅ", "くりーむ", "うすだいだい"], answer: "べーじゅ", colors: ["ピンク", "水色", "黄色"] },
        { question: "茶色！と緑！と青！をまぜたら？", options: ["かーき", "もすぐりーん", "おりーぶ"], answer: "かーき", colors: ["茶色", "緑", "青"] },
        { question: "紫！と赤！と黄緑！をまぜたら？", options: ["ちゃいろ", "はいいろ", "おうどいろ"], answer: "ちゃいろ", colors: ["紫", "赤", "黄緑"] },
        { question: "橙！とピンク！と紫！をまぜたら？", options: ["あかむらさき", "まぜんた", "わいんれっど"], answer: "あかむらさき", colors: ["橙", "ピンク", "紫"] }
    ],
    ura2: [
        { question: "光の赤と光の緑を混ぜると？", options: ["きいろ", "しあん", "まぜんた"], answer: "きいろ", colors: ["光の赤", "光の緑"] },
        { question: "光の緑と光の青を混ぜると？", options: ["しあん", "きいろ", "まぜんた"], answer: "しあん", colors: ["光の緑", "光の青"] },
        { question: "光の青と光の赤を混ぜると？", options: ["まぜんた", "きいろ", "しあん"], answer: "まぜんた", colors: ["光の青", "光の赤"] },
        { question: "光の赤と光の緑と光の青を全部混ぜると？", options: ["しろ", "くろ", "はいいろ"], answer: "しろ", colors: ["光の赤", "光の緑", "光の青"] },
        { question: "光の赤と光の青を混ぜるとできる色は？", options: ["まぜんた", "むらさき", "ぴんく"], answer: "まぜんた", colors: ["光の赤", "光の青"] },
        { question: "光の緑と光の青を混ぜるとできる色は？", options: ["しあん", "みずいろ", "えめらるど"], answer: "しあん", colors: ["光の緑", "光の青"] },
        { question: "光の赤と光の緑を混ぜるとできる色は？", options: ["きいろ", "だいだい", "きみどり"], answer: "きいろ", colors: ["光の赤", "光の緑"] },
        { question: "光の赤と光の緑と光の青のうち、2つを混ぜて黄色になる組み合わせは？", options: ["あかとみどり", "あかとあお", "みどりとあお"], answer: "あかとみどり", colors: ["光の赤", "光の緑"] },
        { question: "光の赤と光の緑と光の青のうち、2つを混ぜてシアンになる組み合わせは？", options: ["みどりとあお", "あかとあお", "あかとみどり"], answer: "みどりとあお", colors: ["光の緑", "光の青"] },
        { question: "光の赤と光の緑と光の青のうち、2つを混ぜてマゼンタになる組み合わせは？", options: ["あかとあお", "あかとみどり", "みどりとあお"], answer: "あかとあお", colors: ["光の赤", "光の青"] }
    ]
};
...
function showHandicapDescription() {
    ...
    if (myHandicap !== "none") {
        const descriptions = {
            'no_type_10': '⏱️ ハンデ: 最初の10秒間はタイピングできません',
            'score_half': '📉 ハンデ: 獲得スコアが半分になります',
            'skill_seal': '🔒 ハンデ: スキルが封印されています',
            'half_time': '⏳ ハンデ: 最初の30秒間はタイピングできません'
        };
        showBattleAlert(descriptions[myHandicap], "#FFA500");
    }
}
